...
export const clinicalSpecialties: ClinicalSpecialty[] = [
  ...
  { code: "bacteriologia", name: "Bacteriología", group: "Diagnóstico", focus: "tipo de muestra, procesamiento y hallazgos micro/macroscópicos", followUp: "resultados de laboratorio y correlación clínica", procedure: "informe de laboratorio clínico y patología" },
