  ...
  const ESCENAS = [
    {
      ...
      u: () => centro(0.5, 0.38),
      cursor: () => null,
      voz: { de: "u", dice: "Hola, soy Ü. Soy el asistente de inteligencia artificial para médicos.", pista: "u-01-hola", dur: 5700 },
    },
    {
    ...
    },
    {
      ...
      u: () => centro(0.5, 0.38),
      cursor: () => null,
      voz: { de: "u", dice: "Para eso, primero miro tu pantalla unos días y aprendo cómo trabajas.", pista: "u-03-aprendo", dur: 5500 },
    },
    {
      ...
      clic: true,
      voz: { de: "u", dice: "Cuando ya aprendí, abro tu sistema. El mismo que usas todos los días.", pista: "u-04-abro", dur: 5750 },
    },
    {
      ...
      voz: { de: "u", dice: "Aquí registras al paciente que viene por primera vez.", pista: "u-05-nuevo", dur: 3700 },
    },
    {
      ...
      clic: true,
      voz: { de: "u", dice: "Y aquí al que ya tiene historia contigo. Entremos por este.", pista: "u-06-conocido", dur: 3900 },
    },
    {
    ...
    },
    {
      ...
      voz: { de: "u", dice: "Después, el examen físico.", pista: "u-08-examen", dur: 2750 },
    },
    {
      ...
      u: () => junto("#d-cita", 1),
      cursor: () => null,
      voz: { de: "u", dice: "Ahora atendamos una cita de verdad. Tú habla con tu paciente; yo escribo.", pista: "u-09-cita", dur: 6300 },
    },
    {
      titulo: "Escuchando.",
    ...
    },
    {
      ...
      cursor: () => null,
      voz: { de: "u", dice: "Listo. La historia quedó completa y tú no tocaste el teclado.", pista: "u-10-listo", dur: 4800 },
    },
    {
      titulo: "Pruébame.",
      ...
      voz: { de: "u", dice: "Si quieres probarme, regístrate aquí abajo.", pista: "u-11-registrate", dur: 3600 },
      alFinal: true,
    },
  ];
